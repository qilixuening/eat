  ...
  <div class="login_index_container">
    ...
    <form class="loginForm" v-else>
      ...
      <section class="input_container">
        ...
        <div
          class="button_switch"
          :class="{ change_to_text: showPassword }"
        >
          <div
            class="circle_button"
      ...
      <section
        class="input_container captcha_code_container"
      >
        <input
          type="text"
          placeholder="验证码"
...
export default {
  name: 'loginIndex',
  data: () => ({
    loginWay: false, // 登录方式，默认短信验证码登录
    showPassword: false, // 是否显示密码
    phoneNumber: undefined, // 电话号码
    mobileCode: undefined, // 短信验证码
