  ...
  <div class="paddingTop search_page">
    <head-top head-title="搜索" :goBack="true" />
      ...
      <section v-if="restaurantList.length">
        <h4 class="title_restaurant" v-text="商家" />
              ...
              <section class="item_right">
                <div class="item_right_text">
                  <p>
                    ...
                    >
                      <polygon
                        points="0,14 4,0 24,0 24,14"
                        style="fill:none; stroke: #ff6000; stroke-width: 1;"
                      />
                      <line
                        x1="1.5" y1="12" x2="20" y2="12"
                  ...
                  <p v-text="`月售 ${item.month_sales || item.rencent_order_num} 单`" />
                  <p v-text="`${item.delivery_fee || item.float_minimum_order_amount
      ...
      <section
        v-if="searchHistory.length && showHistory"
      ...
      >
        ...
        <ul>
          <li
            ...
            :key="index"
          >
            <span class="hisotry_text ellipsis"
              @click="searchTarget(item)"
              v-text="item"
            />
            <svg
              class="delete_icon"
            ...
            >
              <line
                x1="8" y1="8" x2="18" y2="18"
                style="stroke: #999; stroke-width: 3;"
              />
              <line
                x1="18" y1="8" x2="8" y2="18"
                style="stroke: #999; stroke-width: 3;"
              />
            </svg>
          </li>
