        ...
        <hgroup class="shop_right">
          ...
          <h5 class="rating_order_num">
            ...
            <section class="rating_order_num_right">
              <span
                ...
                v-text="item.delivery_mode.text"
              />
              <span
          ...
          <h5 class="fee_distance">
            <p class="fee">
              ...
              <span class="segmentation" v-text="'/'" />
            ...
            <p class="distance_time">
              ...
              <span v-else v-text="item.distance" />
              <span class="segmentation" v-text="'/'" />
              <span class="order_time" v-text="item.order_lead_time" />
            </p>
          </h5>
        </hgroup>
      </router-link>
  ...
  methods: {
    ...
    zhunshi (supports) {
      if ((supports instanceof Array) && supports.length) {
        return supports.some(item => item.icon_name === '准')
      }
      return false
    }
  }
