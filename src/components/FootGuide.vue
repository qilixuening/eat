  ...
  <section id="foot_guide">
    ...
    >
      <svg class="icon_style">
        <use
          :xlink:href="$route.path.indexOf('msite') !== -1 ? '#msiteActive' : '#msite'"
        />
      </svg>
      <span>外卖</span>
    </section>
    ...
    >
      <svg class="icon_style">
        <use
          :xlink:href="$route.path.indexOf('search') !== -1 ? '#findActive' : '#find'"
        />
      </svg>
      <span>搜索</span>
    </section>
    ...
    <section
      class="guide_item"
      @click="gotoAddress('/order')"
    >
      <svg class="icon_style">
        <use
          :xlink:href="$route.path.indexOf('order') !== -1 ? '#orderActive' : '#order'"
        />
      </svg>
      <span>订单</span>
    </section>
    ...
    <section
      class="guide_item"
      @click="gotoAddress('/profile')"
    >
      <svg class="icon_style">
        <use
          :xlink:href="$route.path.indexOf('profile') !== -1 ? '#profileActive' : '#profile'"
        />
      </svg>
      <span>我的</span>
    </section>
